...
const questions = [
  {
    question: "إذا اجتمعت همزتان مفتوحتان في كلمة واحدة (مثل: أأنذرتهم)، فما هو مذهب ورش فيها؟",
    options: ["التحقيق فقط", "التسهيل فقط", "التسهيل والإبدال ألفاً", "الإبدال واواً"],
    correctAnswer: 2,
    explanation: "في الهمزتين المفتوحتين من كلمة لورش وجهان: التسهيل (بين الهمزة والألف) والإبدال (ألفاً خالصة)."
  },
  {
    question: "عند إبدال الهمزة الثانية ألفاً في كلمة ﴿ ءَأَنذَرۡتَهُمۡ ﴾، ما هو مقدار المد؟",
    options: ["حركتان (قصر)", "4 حركات (توسط)", "6 حركات (إشباع)", "لا تُمد"],
    correctAnswer: 2,
    explanation: "تُمد إشباعاً (6 حركات) لأن الحرف الذي بعد الألف المبدلة ساكن (النون في أأنذرتهم)، فيُلحق بالمد اللازم."
  },
  {
    question: "ما هو حكم الهمزتين إذا كانت الأولى مفتوحة والثانية مكسورة (أَئِنَّكُمْ) لورش؟",
    options: ["الإبدال فقط", "التسهيل والإبدال", "التسهيل فقط", "التحقيق"],
    correctAnswer: 2,
    explanation: "في المفتوحة فمكسورة لورش وجه التسهيل فقط (تسهيل الهمزة الثانية بين الهمزة والياء)."
  },
  {
    question: "كم موضعاً وردت فيه الهمزة المفتوحة فمضمومة (أَؤُنَبِّئُكُم) في القرآن الكريم، وما حكمها لورش؟",
    options: ["موضع واحد - وفيها التسهيل", "3 مواضع - وفيها التسهيل", "3 مواضع - وفيها التسهيل والإبدال", "5 مواضع - وفيها التحقيق"],
    correctAnswer: 1,
    explanation: "وردت في 3 مواضع (آل عمران، ص، القمر) وحكمها التسهيل فقط لورش."
  }
];

export function Unit2Quiz({ onComplete }: { onComplete: () => void }) {
    ...
    <div className="max-w-2xl mx-auto animate-in slide-in-from-bottom-4 duration-500">
      <div className="bg-navy-800/80 rounded-2xl border border-navy-700 p-6 md:p-8 shadow-xl backdrop-blur-sm">
        <div className="flex justify-between items-center mb-6">
          ...
          <span className="text-navy-400 text-sm font-medium">الباب الثاني: الهمزتان من كلمة</span>
        </div>
